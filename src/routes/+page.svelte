<main class="layout">
	<header class="px-18 py-8">
		<h1 class="prose md:prose-2xl font-display">Ashlar Co-housing</h1>
	</header>
 ...
 top-30 left-18 max-w-[500px] bg-[hsla(176.59,49.8%,51.57%,0.9)] p-8"
		...
		<img
			class="max-h-[668px] w-full object-cover"
			src="/images/banner-image-1.jpg"
			alt="Various items on a picnic table"
		/>
	</section>
